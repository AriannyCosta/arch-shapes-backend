...
const users = [
    {
    "id":0,"usuario":"arianny.soares","nome":"Arianny Soares Costa","endereco":"Av Autaz Mirim , 282 - Cidade Nova","contato":"9299233778","cidade":"Manaus","estado":"Amazonas","creci":"5480","senha":"123456"
    },
    {
    "id":1,"usuario":"leonardo.souza","nome":"Leonardo da Silva Souza","endereco":"BR 319, KM 13 - Centro","contato":"92905857896","cidade":"Manaus","estado":"Amazonas","creci":"1205","senha":"654321"
    },
    {
    "id":2,"usuario":"ana.brito","nome":"Ana Pacheco Brito","endereco":"Av das Flores ,785 - Cidade Nova","contato":"92980857896","cidade":"Manaus","estado":"Amazonas","creci":"1205","senha":"252525"
    }
];

const properties = [
    {
    "id":0,"proprietario":"Alessandro Oliver Andrade","nome_casa":"residencial multfamiliar","endereco":"Nova vitoria,80 - Zona Leste","contato":"92992232715","status":"Em negociação","valor_imovel":"100000","valor_compra":"150000","comissao":"20", "descricao": "250m²: 2 quartos sendo 1 suíte, garagem para 2 carros, banheiro social e área gourmet"
    },
    {
    "id":1,"proprietario":"Mateus de Santos Cunha","nome_casa":"residencia familiar","endereco":"Av Autaz Mirim , 70 - Distrito 2","contato":"92992233715","status":"Disponível" ,"valor_imovel":"100000","valor_compra":"150000","comissao":"10", "descricao": "270m²: 3 quartos sendo 2 suítes, garagem para 4 carros, banheiro social, piscina e área gourmet"
    },
    {
    "id":2,"proprietario":"Rosana Silva Lira","nome_casa":"duplex","endereco":"Armando Mendes,50 - Distrito 1","contato":"92992233715","status":"Vendido","valor_imovel":"270000","valor_compra":"160000","comissao":"70", "descricao": "300m²: 2 quartos e 1 suíte, banheiro social, garagem para 1 carro, escritório"
    }
];
...
server.delete('/users/:id', (req, res) => {
  ...
  const indexParaRemover = users.findIndex(propriedade => propriedade.id === idParaRemover);
...
server.delete('/imoveis/:id',  (req, res) => {
  ...
  const idParaRemover = id_number; // o id que queremos remover
  const indexParaRemover = properties.findIndex(propriedade => propriedade.id === idParaRemover);
  if (indexParaRemover !== -1) {
